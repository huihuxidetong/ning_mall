...
Page((a = {
  ...
  shopCarList: function () {
    ...
    s.get("member/cart/get_cart", {
      merchid: t.data.merchid,
    }, function (k) {
      var merch_list = [];
      if (null != k.merch_list.length && k.merch_list.length > 0) {
  ...
  clearShopCartFn: function (t) {
    ...
    s.post("member/cart/removeallBymerch", {
      merchid: merchid
    }, function (t) {
      s.get("member/cart/get_cart", {
        merchid: merchid,
